<?php
    ...
    function get(){
        ...
        $query = generateSelectQuery("users", $condition);
        try{        
    ...
    function insert(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateInsertQuery("users", $input);
        //return $query;
        try{  
    ...
    function update(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateUpdateQuery("users", $input,"id");
    ...
    function delete(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateDeleteQuery("users", $input);
