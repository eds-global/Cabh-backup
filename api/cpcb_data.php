<?php
    ...
    function get(){
        ...
        $query = generateSelectQuery("cpcb_data", $condition);
    ...
    function insert(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateInsertQuery("cpcb_data", $input);
        try{  
    ...
    function update(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateUpdateQuery("cpcb_data", $input, "deviceID");
    ...
    function delete(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateDeleteQuery("cpcb_data", $input);
        if($start_date != null && $end_date != null)
        {
