<?php
    ...
    function get(){
        ...
        $query = generateSelectQuery("token_details", $condition);
        try{        
    ...
    function insert(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateInsertQuery("token_details", $input);
        try{  
    ...
    function update(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateUpdateQuery("token_details", $input,"id_token");
    ...
    function delete(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateDeleteQuery("token_details", $input);
