<?php
    ...
    function get(){
        ...
        $query = generateSelectQuery("cpcb_monitors", $condition);
        try{        
    ...
    function insert(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateInsertQuery("cpcb_monitors", $input);
        try{  
    ...
    function update(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateUpdateQuery("cpcb_monitors", $input, "deviceID" );
    ...
    function delete(){
        ...
        $conn = db_connect();
         // parameter - $table, $condition=array(), $columns=array()
        $query = generateDeleteQuery("cpcb_monitors", $input);
