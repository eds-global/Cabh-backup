function getBoxplot(duration, typology, spaceType, sensorID, pollutants, post_url, chart_id){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if(result.ApiResponse=="Success"){
                ...
                updateBoxChart(indoordata, pollutants, chart_id);
            }
        },
...
function updateBoxChart(chart_data, pollutants, chart_id){
